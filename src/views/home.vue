<template>
  <div>
    ...
    <div class="caidan">
      ...
      <a
        href="xinwen_list.html?cs_lxid=11&cs_lxmc=活动列表"
        class="caidan_lianjie"
      >
        <img src="static/img/menu02.png" class="caidan_img" />
        <p>活动列表</p>
      </a>
      <a
        href="xinwen_list.html?cs_lxid=10&cs_lxmc=帮助中心"
        class="caidan_lianjie"
      >
    ...
    <!-- 最新推荐图片 -->
    <div class="cp2_zuixin" v-for="tjcp in tjcps" :key="tjcp">
      <a>
...
export default {
  ...
  methods: {
    ...
    Getxinwen: function () {
      axios
        .get("http://vue.yaoyiwangluo.com/wx_news_list.asp", {
          params: {
            cs_shuliang: 3, // 数量
            cs_lxid: 11, // 类型id
          },
    ...
    GetCps_zuixin: function () {
      axios
        .get("http://vue.yaoyiwangluo.com/wx_CpList_top4.asp")
        .then((response) => {
    ...
    Getrecommend: function () {
      axios
        .get("http://vue.yaoyiwangluo.com/wx_CpList_tuijian4.asp")
        .then((response) => {
